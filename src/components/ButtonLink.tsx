...
export function ButtonLink({
  ...
  return (
    <Link
      href={href}
      className={`inline-flex min-h-11 items-center justify-center rounded-sm px-6 py-3 text-sm font-semibold uppercase tracking-[0.08em] transition ${variants[variant]} ${className}`}
    >
      {children}
    </Link>
  );
